...
public class UpdateFood extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while(list.next()){
                double one_price = Double.parseDouble(list.getString("price"));
                double finalTotal = Double.parseDouble(df.format(one_price*count));
                this.queries.updateFoodItem(model, count, finalTotal);
            }
